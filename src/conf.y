...
con_command:
	   ...
	   | LEX_SSL_CHECK_MODE LEX_EQ LEX_STRING { $$ = tuple_s_new(
			LEX_SSL_CHECK_MODE, $3); }
	   | LEX_NICKSERV_PASSWORD LEX_EQ LEX_STRING { $$ = tuple_s_new(LEX_NICKSERV_PASSWORD,
		 $3); }
channel:
       { $$ = list_new(NULL); }
